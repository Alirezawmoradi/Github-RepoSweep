        ...
        <>
            <div className="hidden xl:block">
                <HoverCard backgroundColor='#939aff' direction='' left='0'>
                    <div className='relative flex items-center justify-center gap-5 w-full overflow-hidden'>
                        <div className='overflow-hidden rounded-s-lg z-[1] flex pl-5 shadow-3xl'>
                            <div
                                className='text-left border-[0.5px] bg-[#161b22] border-[#30363d] rounded-lg text-[#161b22] box-shadow-card xl:mt-10 xl:ml-0 sm:ml-10 sm:mr-10 mb-16 ml-3 mr-3 '>
                                <div className='w-[348px]'>
                                        ...
                                        <div className='flex items-center bg-[#161b22] text-[#7d8590] tab-nav'>
                                            <button onClick={() => {
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" role="img" fill='currentColor'
                                                     viewBox="0 0 24 24" aria-hidden="true" className="octicon mr-2"
                                                     height="16"
                                    ...
                                    <div className={`p-2 relative bg-[#0d1117] ${showLang ? "" : "hidden"}`}>
                                        <div className='flex w-full'>
                                            ...
                                            <div
                                                className='flex flex-col overflow-hidden text-white rounded-b-md w-full'>
                                    <pre className=""><span className="code-editor-line-mktg d-inline-block"><span
                                        ...
                                        className="pl-c1">&apos;@{language}&apos;</span></span></pre>
                                                <pre className=""><motion.span variants={container} initial='hidden'
                                                    ...
                                                    variants={item}
                                                    className="pl-k js-type-letters">function</motion.span><motion.span
                                                    variants={item} className="js-type-letters"> </motion.span><motion.span
                                                    variants={item}
                                                    className="pl-s1 js-type-letters">removeRepo</motion.span><motion.span
                                                    variants={item} className="js-type-letters"> </motion.span><motion.span
                                                    variants={item}
                                                    className="pl-c1 js-type-letters">{'() {'}</motion.span><motion.span
                                        ...
                                        <pre className=" bg-[#388bfd1a]"><span><span
                                            ...
                                            className="pl-s1">{'onClick(clickMe)>'}</span>
                                                    ...
                                                    <pre className=" bg-[#388bfd1a]"><span><span
                                                        ...
                                                        className="pl-s1"></span> <span
                                                        className="pl-c1">🗑️</span> <span
                                                        className="pl-c1"></span></span></pre>
                                                    <pre className=" bg-[#388bfd1a]"><span><span
                                                        className="pl-5">{'</Button'}</span> <span
                                                        className="pl-s1">{'>'}</span> <span
                                                        className="pl-c1"></span> <span
                                                        className="pl-s1"></span> <span className="pl-c1"></span> <span
                                                        className="pl-c1"></span></span></pre>
                                                    <pre className=" bg-[#388bfd1a]"><span><span
                                                        className="pl-k"></span><span
                                                    ...
                                                    <div
                                                        ...
                                                        <a onMouseEnter={() => setHovered(true)}
                                                           onMouseLeave={() => setHovered(false)} href={html_url}
                                                           className=' xl:text-sm text-white font-semibold inline-block'>
                                                            View on GitHub
                                                            <div
                        ...
                        <div className='flex flex-col p-8 sm:p-10 justify-start text-left w-8/12'>
                            <div className='flex flex-col mb-32 cursor-default'>
                                <div className='flex flex-row mb-6 justify-start items-center gap-2'>
                                    <p className=" text-xl xl:text-2xl font-medium text-[#7d8590]">
            ...
            <div className="block sm:flex sm:justify-center sm:items-center sm:w-full xl:hidden">
                <div className="flex justify-between items-center w-72 sm:w-10/12 border-b border-gray-800 sm:px-5 pb-3">
                    <div className="flex flex-col text-white gap-5">
                        <div className='flex items-center justify-between gap-5'>
                            <p className="font-medium text-sm md:text-xl">{name}</p>
                            <Badge
                                className={`text-xs border border-gray-700 px-2 py-1 rounded-3xl ${isPrivate ? 'text-red-500' : 'text-green-500'}`}>{isPrivate ? 'Private' : 'Public'}</Badge>
                            <RepoStars>{stargazers_count}</RepoStars>
                        </div>
                        <p className="text-gray-400 text-xs md:text-sm">{description ? description : 'No description available.'}</p>
                    </div>
                        <div className="relative cursor-pointer mt-10" onClick={onSelect}>
                            <Checkbox onSelect={onSelect} isSelected={isSelected}/>
                        </div>
                </div>
            </div>
