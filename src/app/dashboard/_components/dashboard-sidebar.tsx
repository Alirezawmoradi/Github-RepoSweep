            ...
            <aside className="hidden xl:block col-span-1 xl:col-span-3 pl-10 sticky top-20 h-screen">
                <div className="flex flex-col items-center text-white">
                    ...
                    <div className="mt-6 text-center text-sm">
                        ...
                        <div
                            className={`flex justify-between mt-10 relative ${loading && initialLoad ? 'hidden' : 'block'}`}>
                            <Button
                                onClick={openModal}
                                type='default'
            ...
            <div className="flex flex-col items-center w-full justify-center mr-auto xl:hidden mt-6">
                    <div className="flex items-center justify-center px-5">
                        {loading && initialLoad ? (
                            ...
                            <Avatar className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24" src={userData?.avatar_url} alt="Profile Image"/>
                        )}
                        <div className="ml-4">
                            {loading && initialLoad ? (
                    ...
                    <div
                        className={`flex justify-center mt-4 ${
                            loading && initialLoad ? "hidden" : "block"
                        }`}
                    >
                        <Button
                            onClick={openModal}
