    ...
    return <aside className="col-span-1 xl:col-span-3 pl-10 sticky top-20 h-screen">
        <div className="flex flex-col items-center text-white">
            {loading ?
                ...
                :
                <Avatar className={`w-64 h-64 ${loading ? 'border-none' : 'border-4'}`}
            ...
            <div className="mt-6 text-center text-sm">
                ...
                <div className="flex justify-between mt-10 relative">
                    <button
                        onClick={openModal}
                        className={`bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded ${loading ? 'hidden' : 'block'}`}
                    >
